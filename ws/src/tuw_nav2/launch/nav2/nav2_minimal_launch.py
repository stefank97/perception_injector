        ...
        def create_rewritten_yaml(context: LaunchContext, source_file_name):
            ...
            if context.launch_configurations['namespace']:
                tmp_file = ReplaceString(
                        ...
                        replacements={'/scan': ('/', namespace, '/scan_filtered')})
        ...
        actions=[
            ...
            Node(
                ...
                parameters=[LaunchConfiguration('bt_navigator_yaml_param_file_path'),
                            ...
                            {'default_nav_to_pose_bt_xml': get_package_share_directory('tuw_nav2') + "/config/nav2_bt_navigator/navigate_to_pose.xml"}
                            ],
                arguments=['--ros-args', '--log-level', log_level],
                remappings=remappings),
#"/config/nav2_bt_navigator/navigate_through_poses_w_replanning_and_recovery_v3.xml"
#"/config/nav2_bt_navigator/navigate_to_pose_w_replanning_and_recovery.xml"
            Node(
